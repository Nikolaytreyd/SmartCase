...
2. Подлкючение ML Regressor c автотюнингом гиперпараметров. На данном этапе реализованы возможности использования:
   ...
   ![example2](images/XGBoostRegressor.png)
...
8. Анализ чувстительности - PDP анализ

   ![example4](images/ga_info.png)
   

10. Расчет устойчивости
11. Сравнительный анализ базовых решений и решений сгенерированных  с использованием SmartCase.exe
