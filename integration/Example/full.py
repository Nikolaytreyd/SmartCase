...
""")
    ...
    if False:
        begin_wf_item (index = 18, name = "Сетка")
        workflow_folder ()
        if True:
            pass
    ...
    if False:
        begin_wf_item (index = 28, name = "Базовое свойство", collapsed = True)
        workflow_folder ()
        if True:
            pass
...
""")
    ...
    if True:
        ...
        if False:
            begin_wf_item (index = 121, name = "Опция \"Нефть\"")
            workflow_folder ()
            if True:
                pass
                ...
                if False:
                    begin_wf_item (index = 122, is_custom_code = True, name = "Определение переменных моделей")
                    manager_oil = Manager(
                ...
                begin_wf_item (index = 123, name = "Пояснения ")
                comment_text ("""
...
""")
                ...
                if False:
                    begin_wf_item (index = 124, name = "Запуск main.exe")
                ...
                if False:
                    begin_wf_item (index = 125, name = "Работа с скважинами")
                    workflow_folder ()
                    if True:
                        pass
                        ...
                        if False:
                            begin_wf_item (index = 126, is_custom_code = True, name = "Удалить")
                            print(get_all_wells())
        ...
        begin_wf_item (index = 130, name = "Опция \"Газ\"")
        workflow_folder ()
        if True:
            pass
            ...
            if False:
                begin_wf_item (index = 131, is_custom_code = True, name = "Определение переменных моделей")
                manager_gas = Manager(
            ...
            begin_wf_item (index = 132, name = "Пояснения ")
            comment_text ("""
Путь к variable_file должен:
...
""")
            ...
            begin_wf_item (index = 133, name = "Запуск main.exe")
            execute_external_program (program="D:/14. Кейсы/005. IRM/res/SmartCase/SmartCase.exe",
            ...
            if False:
                begin_wf_item (index = 134, name = "Работа с скважинами")
                workflow_folder ()
                if True:
                    pass
...
""")
        ...
        if False:
            begin_wf_item (index = 142, name = "Управление скважинами")
